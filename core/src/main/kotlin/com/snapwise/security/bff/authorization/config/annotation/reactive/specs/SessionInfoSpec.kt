...
class SessionInfoSpec(private val configurer: AbstractServerConfigurer): AbstractBffServerSpec() {
     ...
     * @return the [SessionInfoSpec] to continue configuring
     */
    fun securityContextRepository(securityContextRepository: ServerSecurityContextRepository): SessionInfoSpec {
     ...
     * @return the [SessionInfoSpec] for further configuration
     * @since 5.2
     */
    fun authenticationMatcher(requestMatcher: ServerWebExchangeMatcher): SessionInfoSpec {
    ...
    override fun init(httpSecurity: ServerHttpSecurity) {
        ...
        httpSecurity.addFilterAt(sessionInfoWebFilter, SecurityWebFiltersOrder.FIRST)
    }
