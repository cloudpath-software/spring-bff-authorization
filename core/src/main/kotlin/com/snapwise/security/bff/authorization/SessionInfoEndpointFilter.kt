...
/**
 * A `Filter` for the Bff session information endpoint,
 ...
 * at the `URI` `/bff/oauth2/bff-sessioninfo` and `HttpMethod` `POST`.
 *
 *
 *
 * The default endpoint `URI` `/bff/oauth2/bff-sessioninfo` may be overridden
 * via the constructor [.SessionInfoEndpointFilter].
 *
 * @since 0.0.1
 ...
 */
class SessionInfoEndpointFilter @JvmOverloads constructor(
    authenticationManager: AuthenticationManager,
    tokenEndpointUri: String? = DEFAULT_SESSION_INFO_ENDPOINT_URI
    ...
    init {
        ...
        tokenEndpointMatcher = AntPathRequestMatcher(tokenEndpointUri, HttpMethod.GET.name())
