...
/**
 * A `Filter` for the Bff login endpoint,
 ...
 *
 *
 * The default endpoint `URI` `/bff/oauth2/bff-sessionend` may be overridden
 * via the constructor [.SessionEndEndpointFilter].
 *
 * @since 0.0.1
 ...
 */
class SessionEndEndpointFilter @JvmOverloads constructor(
    authenticationManager: AuthenticationManager,
    tokenEndpointUri: String? = DEFAULT_SESSION_END_ENDPOINT_URI
