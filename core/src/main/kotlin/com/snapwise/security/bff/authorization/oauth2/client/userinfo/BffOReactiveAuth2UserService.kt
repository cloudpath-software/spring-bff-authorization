...
open class BffOReactiveAuth2UserService(private val userSessionService: UserSessionService): ReactiveOAuth2UserService<OAuth2UserRequest, OAuth2User> {

    private val restOperations = RestTemplate()

    private val userSessionAuthenticationProvider: UserSessionAuthenticationProvider =
        UserSessionAuthenticationProvider(userSessionService)
