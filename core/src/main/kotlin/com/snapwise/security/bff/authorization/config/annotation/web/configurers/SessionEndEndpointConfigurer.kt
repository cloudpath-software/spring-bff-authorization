 ...
 */
class SessionEndEndpointConfigurer
/**
...
internal constructor(objectPostProcessor: ObjectPostProcessor<Any>) : AbstractBffConfigurer(objectPostProcessor) {
     ...
     */
    fun accessTokenRequestConverter(accessTokenRequestConverter: AuthenticationConverter): SessionEndEndpointConfigurer {
     ...
     * @return the [OAuth2TokenEndpointConfigurer] for further configuration
     */
    fun authenticationProvider(authenticationProvider: AuthenticationProvider): SessionEndEndpointConfigurer {
     ...
     * @return the [OAuth2TokenEndpointConfigurer] for further configuration
     */
    fun accessTokenResponseHandler(accessTokenResponseHandler: AuthenticationSuccessHandler): SessionEndEndpointConfigurer {
     ...
     * @return the [OAuth2TokenEndpointConfigurer] for further configuration
     */
    fun errorResponseHandler(errorResponseHandler: AuthenticationFailureHandler): SessionEndEndpointConfigurer {
    ...
    override fun init(httpSecurity: HttpSecurity) {
        ...
        requestMatcher = AntPathRequestMatcher(
            authorizationServerSettings.sessionEndEndpoint, HttpMethod.POST.name()
        )
    ...
    override fun configure(httpSecurity: HttpSecurity) {
        ...
        val authorizationServerSettings: BffAuthorizationSettings =
            BffAuthorizationConfigurerUtils.getAuthorizationSettings(httpSecurity)
        val tokenEndpointFilter = OAuth2TokenEndpointFilter(
            authenticationManager,
            authorizationServerSettings.sessionEndEndpoint
        )
