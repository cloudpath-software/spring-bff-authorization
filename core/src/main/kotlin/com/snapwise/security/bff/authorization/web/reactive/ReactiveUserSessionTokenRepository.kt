 ...
 */
interface ReactiveUserSessionTokenRepository {
    /**
     ...
     */
    fun generateToken(request: ServerHttpRequest): Mono<UserSessionAuthenticationToken?>
     ...
     */
    fun saveToken(token: UserSessionAuthenticationToken?, request: ServerHttpRequest, response: ServerHttpResponse)
     ...
     */
    fun loadToken(request: ServerHttpRequest): Mono<UserSessionAuthenticationToken?>
     ...
     */
    fun loadDeferredToken(request: ServerHttpRequest, response: ServerHttpResponse): ReactiveDeferredUserSessionToken {
        return ReactiveRepositoryDeferredUserSessionToken(this, request, response)
    }
}